...
np.savez('Results/DNN/central_model.npz',hist_l=hist.history['loss'],hist_mse=hist.history['mse'])
model_central.save('Results/DNN/central_model',include_optimizer = True)
