...
model_central = create_CNN_model()
...
np.savez('Results/CNN/central_model.npz',hist_l=hist.history['loss'],hist_mse=hist.history['mse'])
model_central.save('Results/CNN/central_model',include_optimizer = True)
