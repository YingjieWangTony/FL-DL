...
model_central = create_wavenet_model()
...
np.savez('Results/wavenet/central_model.npz',hist_l=hist.history['loss'],hist_mse=hist.history['mse'])
model_central.save('Results/wavenet/central_model',include_optimizer = True)
